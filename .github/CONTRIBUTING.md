# Contributing to [GH_REPO]

Love [GH_REPO] and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/altcoder/[GH_REPO]/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/[GH_REPO].git
   # Navigate to the newly cloned directory
   cd [GH_REPO]
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/altcoder/[GH_REPO].git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/altcoder/[GH_REPO]/blob/master/LICENSE.md).
